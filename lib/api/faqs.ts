...
export const faqsApi = {
  ...
  create: (input: Omit<Faq, 'id'>) => fetcher.post<Faq>('/admin/faqs', input),
  replace: (id: string, input: Omit<Faq, 'id'>) => fetcher.put<Faq>(`/admin/faqs/${id}`, input),
  update: (id: string, input: Partial<Faq>) => fetcher.patch<Faq>(`/admin/faqs/${id}`, input),
